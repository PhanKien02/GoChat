...
export const initialMessages: Message[] = [
  ...
  },
  {
    ...
    sender: currentUser,
    content:
      "Yes! The new Tailwind configuration looks super clean. I especially love the updated `globals.css` variables.",
  ...
  },
  {
    ...
    sender: users[1],
    content:
      "Awesome. Let me know if you need any help with the Next.js setup. \n\nHere is a snippet to get you started with the `TooltipProvider`:\n```tsx\n<TooltipProvider>\n  {children}\n</TooltipProvider>\n```",
