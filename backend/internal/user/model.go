...
type UserModel struct {
	...
	Username  string        `bson:"username,omitempty,required,index:text" json:"username,omitempty"`
	Email     string        `bson:"email,omitempty,required ,index:text" json:"email,omitempty"`
